...
tags: ["open science", "open research", "reproducible research", "data management", "talks"]
comments: true
---

In this interactive talk at the Hong Kong University of Science and
Technology [RDM Symposium
...
The actual title of this talk is in two parts:
...
The goal is to have a combined seminar, where we would mix some of
Laurent's experience as an open researcher/teacher and Marta's
experience from TU Delft in providing the support to help researchers
achieve these goals.

We hope that by doing this we would appeal to both researchers and to
support staff in the audience:
...
their research more Findable, Accessible, Interoperable and Re-usable
(FAIR).
...
We are Marta Teperek (Head of Research Data Services at TU Delft
Library and Director of 4TU.ResearchData, The Netherlands) and Laurent
Gatto (Computational Biology and Bioinformatics Unit, de Duve
Institute, UCLouvain, Belgium)

A week or so before the seminar, we had 158 registered attendees. Out
of which 114 are research postgraduate students, 26 are HKUST
staff/faculty, and 9 are guest participants (librarians from other HK
universities).  The break-down of HKUST participants' school
...
In 2010 Laurent was doing his postdoc at the Department of
Biochemistry at Cambridge. At the same time, Marta was doing her PhD
at the Gurdon Institute. We were literally next door, worked on
similar types of research (in fact Marta even collaborated with
Laurent's group on some proteomics analysis in her research) and yet
we have only met each other properly in 2016 when our shared passion
for open and reproducible research practice allowed us to connect in
context of the Data Champions initiative. Laurent was then a Data
Champion, and Marta part of the Research Data Services at Cambridge.
...
you are. And reciprocally, not having any badge to display excludes
one from being an open researcher. And as soon as people start to
believe this, we will stop practicing open research and will start
doing stamp collection.
...
But open and reproducible research, **supported by good data
management**, lead to **trust, verification and guarantees**:
...
(see Gabriel Becker [An Imperfect Guide to Imperfect
...
collaborators/students' benefit. Hence, it is natural to center the
lab's activities around the principles of good data management to
enable open and reproducible research.
...
From left to right, an example of practice of open and reproducible
...
[preprint](https://doi.org/10.1101/377630) and [peer reviewer
paper](https://doi.org/10.1016/j.cbpa.2018.11.015).
...
Policies aren't the main motivation to practice good data
management. It is important for data management to be an intrinsic
motivation, which can easily be triggered by the desire to produce
trusted research. Local action, at a lab's level is possible and/or at
the initiative of one or a few motivated researchers (early career
researchers and faculty) is easy and efficient, but it is extremely
difficult to expand outside of one's direct environment. For this,
...
source software practices across the entire institution.  Training
...
Carpentries instructor (as an ECR); now applying these lessons and
best practices in my university courses (bachelor and masters in
biomedical sciences); also teaching these in workshops for graduate
students and ECR.

Teaching data management, open and reproducible research principles
when running a lab guarantees that students that are well trained in
RDM and RR are readily up to speed.
...
Rewards from teaching **data management, open and reproducible
research principles when running a lab**: students that are well
trained in RDM and RR are readily up to speed.
